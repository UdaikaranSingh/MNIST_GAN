...
from conditional_model import Generator, Discriminator
...
if cuda_available:
	generator = Generator(batch_size, latent_size, num_classes).cuda()
	discriminator = Discriminator(batch_size, latent_size, num_classes).cuda()

	if os.path.exists("generator_model_conditional.pth"):
		print("Loading in Models")
		generator.load_state_dict(torch.load("generator_model_conditional.pth"))
		discriminator.load_state_dict(torch.load("discriminator_model_conditional.pth"))
else:
	generator = Generator(batch_size, latent_size, num_classes)
	discriminator = Discriminator(batch_size, latent_size, num_classes)
...
for epoch in range(num_epochs):
	...
	path = "generator_model_conditional.pth"
	torch.save(generator.state_dict(), path)
	path = "discriminator_model_conditional.pth"
